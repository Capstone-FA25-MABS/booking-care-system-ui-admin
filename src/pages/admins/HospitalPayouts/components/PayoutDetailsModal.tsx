...
const PayoutDetailsModal: React.FC<PayoutDetailsModalProps> = ({
    ...
    const renderContent = () => {
        ...
        if (!payout) {
            return <Alert variant="info">No payout data available</Alert>;
        }
                        ...
                        <Row>
                            <Col md={6}>
                                <div className="mb-3">
                                    ...
                                    <div className="fw-bold">{payout.hospitalName || 'N/A'}</div>
                                </div>
                            </Col>
                            <Col md={6}>
                                <div className="mb-3">
                            ...
                            <Col md={6}>
                                <div className="mb-3">
                                    <small className="text-muted">Number of Appointments</small>
                                    <div className="fw-bold fs-4">{payout.appointmentCount}</div>
                                </div>
                            </Col>
                        </Row>
                    </Card.Body>
                    ...
                    <Card.Body>
                        <Row>
                            ...
                            <Col md={6} className="text-center">
                                <small className="text-muted d-block mb-2">VietQR Code</small>
                                <img
                                    ...
                                    <tbody>
                                        {appointments.map((apt) => (
                                            <tr key={apt.appointmentId}>
                                                ...
                                                <td>{formatDateTime(apt.paymentCompletedAt)}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </Table>
                    ...
                    <Card.Body>
                        <Row>
                            <Col md={6}>
                                ...
                                <div className="mb-3">
                                    <small className="text-muted">Generated By Admin ID</small>
